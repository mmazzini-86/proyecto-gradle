...
public class Steps {
    ...
    public void presiona_el_boton_igresar_del_home_para_realizar_una_consulta_de_saldo() throws InterruptedException {
        HomePage.setBtnIngresarHome();
    }
    ...
    public void presiona_el_boton_ingresar_en_el_login_para_realizar_una_consulta_de_saldo() throws InterruptedException {
        HomePage.setSubmitIngresar();
    }
